# TrendSurge — Sprints del Hackathon
...
```env
# backend/.env
TrendSurge_PROGRAM_ID=7us4TNvEtKYiq55ZKfAPztkCei8PpjwLsyCtuCLBAJaR
...
# web/.env
VITE_TrendSurge_PROGRAM_ID=7us4TNvEtKYiq55ZKfAPztkCei8PpjwLsyCtuCLBAJaR
